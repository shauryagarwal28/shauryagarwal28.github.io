...
### 🔍 Product Teardowns
Full 10-component teardowns: problem statement · user personas · journey map · pain points · prioritisation · solutions · MVP design · go-to-market
...
| File | |
|---|---|
| `Shaurya_Agarwal_Resume.pdf` | Resume |
| `Nextleap_Certificate.pdf` | Nextleap PM Fellowship Certificate |

---

## Built with

Pure HTML · CSS · Vanilla JS · Google Fonts · GitHub Pages
